                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput"
                            placeholder="Descripcion" name="descripcion" value="{{ old('descripcion') }}" required autocomplete="off">
                        <label for="floatingInput">Descripcion</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput"
                            placeholder="Unidad de Medida" name="unidadMedida" value="{{ old('unidadMedida') }}" required autocomplete="off">
                        <label for="floatingInput">Unidad de Medida</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="number" step="1" min="0" class="form-control" id="floatingInput"
                            placeholder="Stock" name="stock" value="{{ old('stock') }}" required autocomplete="off">
                        <label for="floatingInput">Stock</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="number" step="0.01" class="form-control" id="floatingInput"
                            placeholder="Precio" name="precio" min="0" value="{{ old('precio') }}" required autocomplete="off">
