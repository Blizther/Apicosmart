    ...
    <div class="row g-4">
        <div class="col-sm-12">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4 mb-3">
                <div>
                    <h1 class="mb-1">Editar inspección</h1>
                    <small>Modifique el formulario</small>
                </div>
                <h3 class="mb-0">
        ...
        {{-- FORMULARIO --}}
        <form action="{{ route('inspeccion.update', $inspeccion->id) }}"
              method="POST"
              class="col-12">
            @csrf
            @method('PUT')
            ...
            <div class="bg-light rounded h-100 p-3 row">
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php
                        $hoy = date('Y-m-d');
                        $fechaDB = $inspeccion->fechaInspeccion
                            ? \Carbon\Carbon::parse($inspeccion->fechaInspeccion)->format('Y-m-d')
                            : $hoy;
                        $fechaOld = old('fechaInspeccion', $fechaDB);
                    @endphp
                    <input
                        type="date"
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php $estadoOld = old('estadoOperativo', $inspeccion->estadoOperativo); @endphp
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php $tempOld = old('temperamento', $inspeccion->temperamento); @endphp
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php $intOld = old('intensidadImportacion', $inspeccion->intensidadImportacion); @endphp
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php $reinaOld = old('estadoReina', $inspeccion->estadoReina); @endphp
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php $mielOld = old('reservaMiel', $inspeccion->reservaMiel); @endphp
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php $polenOld = old('reservaPolen', $inspeccion->reservaPolen); @endphp
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php $celdasOld = old('celdasReales', $inspeccion->celdasReales); @endphp
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php $patronOld = old('patronPostura', $inspeccion->patronPostura); @endphp
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    @php $enfOld = old('enfermedadPlaga', $inspeccion->enfermedadPlaga); @endphp
                ...
                <div class="col-12 mb-3 form-group">
                    ...
                    <textarea name="notas" id="notas" class="form-control" rows="3">{{ old('notas', $inspeccion->notas) }}</textarea>
                </div>
